...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`dark:bg-slate-900 dark:text-white  max-w-screen-2xl container max-auto md:px-20 px-4 h-14 fixed top-0 left-0 right-0 z-50 ${
          sticky
      ...
      >
        <div className="navbar ">
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="">
              <a
                className="bg-black text-white px-3 py-1 rounded-md hover:bg-slate-700 duration-300 cursor-pointer"
                onClick={() =>
